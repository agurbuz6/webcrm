...
{
    public partial class MusteriArama : System.Web.UI.Page
    {
        ...
        protected void ASPxButton1_Click(object sender, EventArgs e)
        {
            ...
            if (ASPxRadioButtonList1.SelectedIndex.Equals(0))
            {
                ...
                string sorgu = "Select * from tablems where mtcno Like '" + srg + "%'";
            ...
            else if (ASPxRadioButtonList1.SelectedIndex.Equals(1))
            {
                ...
                string sorgu = "Select * from tablems where mad Like '" + ASPxTextBox1.Text + "%'";
                DataSet ds = new DataSet();
              OracleDataAdapter adap = new OracleDataAdapter(sorgu, conn);
                DataTable tablo = new DataTable();
            ...
            else if (ASPxRadioButtonList1.SelectedIndex.Equals(2))
            {
                ...
                conn.Open();
                string sorgu = "Select * from tablems where msoyad Like '" + ASPxTextBox1.Text + "%'";
                DataSet ds = new DataSet();
           OracleDataAdapter adap = new OracleDataAdapter(sorgu, conn);
                DataTable tablo = new DataTable();
